...
export default function FacultyEditProfile({ navigation }) {
...
const styles = StyleSheet.create({
    ...
    header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingBottom: 12, backgroundColor: 'rgba(245, 245, 245, 0.9)', borderBottomWidth: 1, borderBottomColor: 'rgba(229, 231, 235, 0.5)', zIndex: 10 },
    headerSide: { width: 64, justifyContent: 'center' },
    headerTitle: { flex: 1, textAlign: 'center', fontSize: 18, fontWeight: 'bold', color: '#101318', letterSpacing: -0.5 },
    cancelButton: { color: '#0055ff', fontSize: 16, fontWeight: '500' },
    saveButton: { color: '#0055ff', fontSize: 16, fontWeight: 'bold' },
    ...
    editIconBadge: { position: 'absolute', bottom: 0, right: 0, backgroundColor: '#0055ff', width: 36, height: 36, borderRadius: 18, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: 'white', zIndex: 20 },
    changePhotoText: { color: '#0055ff', fontSize: 14, fontWeight: '600', marginTop: 16 },
    formContainer: { paddingHorizontal: 16, gap: 20 },
    formSection: { gap: 16 },
    sectionTitle: { fontSize: 12, fontWeight: 'bold', color: '#5e6d8d', textTransform: 'uppercase', letterSpacing: 1, marginLeft: 4 },
    inputGroup: { gap: 6 },
    inputLabel: { fontSize: 14, fontWeight: '500', color: '#5e6d8d', marginLeft: 4 },
    input: { backgroundColor: 'white', borderWidth: 1, borderColor: '#e5e7eb', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, color: '#101318' },
    textArea: { backgroundColor: 'white', borderWidth: 1, borderColor: '#e5e7eb', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, color: '#101318', minHeight: 80 },
    rowInputs: { flexDirection: 'row', gap: 16 },
    actionSection: { paddingTop: 24, gap: 12 },
    primaryActionButton: { backgroundColor: '#0055ff', height: 56, borderRadius: 12, justifyContent: 'center', alignItems: 'center', shadowColor: '#0055ff', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 6 },
